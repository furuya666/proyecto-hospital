...
<body class="subadmin-site vertical-layout content-left-sidebar navbar-floating footer-static pace-done menu-hide vertical-overlay-menu" data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar" style="transform: none;">
                            ...
                            <div class="card-header" style="display: block">
                                <div class="row row_type">
                                    <div class="col-md-8 col-12">
                                        <h4 class="card-title">Mis Diagnosticos - Juan test Medico</h4>
                                        <br>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <a href="{{ '#' }}" class="btn btn-outline-success waves-effect" id="new-device" data-toggle="modal" data-target="#modalCentered" title="Nuevo diagnostico">
                                            <i data-feather='plus'></i> Nuevo Diagnostico
                                        </a>
                                    ...
                                    <table id="table_default" class="table table_design table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <center>TIPO DE ECOGRAFIA</center>
                                                </th>
                                                <th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                    $d = \App\Ecografia::where('id', $item->ecografia_id)->first();
                                                    @endphp
                                                    <center>{{ $d->tipo}}</center>
                                                </td>
                                                <td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modaldevice-edit{{ $item->id }}">Editar Diagnostico</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{url('medical-center/diagnosis/edit')}}" method="POST">
                        {{ csrf_field()}}
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select class="max-length-multiple form-control form-control-lg" name="ecografia_id">
                                            <option value="">Seleccione</option>
                                            @foreach($items as $item1)
                                            @if(old('id')==$item->id && old('ecografia_id'))
                                            <option value="{{ $item1->id }}" @if(old('id')==$item->id&&old('ecografia_id')==$item1->id) selected @endif>{{ $item1->tipo }}</option>
                                            @else
                                            <option value="{{ $item1->id }}" @if($item1->id==$item->ecografia_id) selected @endif>{{ $item1->tipo }}</option>
                                            @endif
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="name">Nombre Del Diagnostico (<span class="text-danger font-weight-bold">*</span>)</label>
                                    <div class="input-group input-group-merge">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i data-feather="edit-3"></i></span>
                                        </div>
                                        <input type="text" id="name" class="form-control" name="name" placeholder="Escriba el nombre del diagnostico" value="@if(old('id')==$item->id){{ old('name', $item->tipo) }}@else{{ $item->tipo }}@endif" required />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modalCentered" tabindex="-1" role="dialog" aria-labelledby="modalCenteredTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCenteredTitle">Crear Nuevo Diagnostico</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <br>
                    <form action="{{url('medical-center/diagnosis/create')}}" method="POST">
                        {{ csrf_field()}}
                        <div class="row">
                            <br>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select class="max-length-multiple form-control form-control-lg" name="ecografia_id" id="b" data-live-search="true">
                                            <option value="">Seleccione</option>
