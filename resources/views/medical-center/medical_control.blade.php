                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <center>{{ucfirst($d1->nombre)}}</center>
                                                </td>
                                                <td>
                                                    <center>{{ucfirst($d1->apellido_paterno)}} {{ucfirst($d1->apellido_materno)}}</center>
                                                </td>
                                                <td>
                                                    <center>{{ucfirst($d1->ci)}} </center>
                                                </td>
                                                <td>
                                                    <center>{{ucfirst($item->fecha)}}</center>
                                                </td>

                                                <td class="text-center p-0" title="Descargar comprobante de pago">
                                                    <center>
                                                        <a href="{{ url("business-module/devices/$item->id?pdf=1") }}" target="_blank" style="color: #28c76f"><i data-feather='download'></i> PDF</a>
                                                    </center>
                                                </td>
                                            </tr>
                                            @endforeach
