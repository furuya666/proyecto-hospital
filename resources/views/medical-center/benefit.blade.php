                                ...
                                <div class="row row_type">
                                    ...
                                    <div class="col-12">
                                        <a href="{{ '#' }}" class="btn btn-outline-success waves-effect" id="new-device" data-toggle="modal" data-target="#modalCentered" title="Nueva Ecografia">
                                            <i data-feather='plus'></i> Nueva Prestacion
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modaldevice-edit{{ $item->id }}">Editar Prestacion</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{url('medical-center/benefit/edit')}}" method="POST">
                        {{ csrf_field()}}
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="name">Nombre de la prestacion (<span class="text-danger font-weight-bold">*</span>)</label>
    ...
    <div class="modal fade" id="modalCentered" tabindex="-1" role="dialog" aria-labelledby="modalCenteredTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCenteredTitle">Crear Nueva Prestacion</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <br>
                    <form action="{{url('medical-center/benefit/create')}}" method="POST">
                        {{ csrf_field()}}
                        <div class="row">
                            <br>
                            <div class="col-12">
                        ...
                        <div class="modal-footer modal_footer-int">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                            <button type="submit" class="btn btn-primary">Crear Prestacion</button>
                        </div>
                    </form>
                </div>
            </div>
