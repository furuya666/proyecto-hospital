                    ...
                    <div class="auth-inner py-2">
                        <div class="card mb-0 card_type-login">
                            <div class="card-body shadow">
                                ...
                                <form action="{{url('medical-center/auth/login')}}" method="POST">
                                    {{ csrf_field()}}
                                    <div class="form-group">
                                        <label for="email" class="form-label">Rol</label>
                                        <select class="form-control form-control-merge" name="rol" id="b" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge" id="password" name="password" tabindex="2" placeholder="············" aria-describedby="password" required="" value="">
